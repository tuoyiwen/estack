---
project: estack
type: original-source-fulltext
status: full-text-archived
created: 2026-07-03
updated: 2026-07-03
source_url: https://www.bestblogs.dev/article/e44268ef
...
confidence: full-text-provided-by-user
---

# HBR: AI Adoption Is Overloading Your Middle Managers

## Archive Status

全文已归档。该文件由用户上传/提供的原文整理而成，供 estack 私人知识库内部分析使用。
...
这篇文章应作为 estack 的 **middle-manager load / organization absorption layer** 材料，而不是普通 AI adoption 新闻。核心机制是：AI 提升底层产出速度和高层战略想象，但把验证、质量控制、指导、标准解释和知识沉淀的隐性成本压给中层。

可提炼为三个治理断裂：

- 学习是非正式的，但交付压力持续存在。
- 激励机制奖励个人产出，而不是知识共享和团队方法沉淀。
- 高层和中层对 AI adoption 的现实感不同，中层承担解释和兜底。
...
Survey data shows broad but shallow AI adoption and uneven value creation. Roughly [88% of organizations](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai) now use AI in at least one business function, but only about a quarter have developed the capabilities to generate tangible value beyond initial pilots.

[McKinsey research](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai) identifies workflow redesign, not technology sophistication, as the primary driver of AI impact, and our interviews help explain why. At the senior level, leaders are leaning into AI’s strategic potential, expanding scope, accelerating delivery with leaner teams, and reimagining services. At the junior level, consultants report dramatic productivity gains: Desktop research that once took days now takes 30 minutes; analysis that once consumed weeks now only takes hours. Freed from early-stage work, juniors are doing strategic synthesis and sitting in on discovery interviews earlier in their careers than in any prior generation.

But the efficiency gains at the bottom and the strategic ambitions at the top converge on a single pressure point: middle managers. Our interviews and research reveal that managers are drowning from being responsible for catching “[workslop](https://hbr.org/2025/09/ai-generated-workslop-is-destroying-productivity),” AI-generated content that looks professional, but lacks substance and fails to advance the actual task. They’re expected to validate AI outputs, identify errors, coach their teams in AI skills and core on-the-job principles, and uphold quality standards—all while facing unchanged or even increased delivery pressure and lacking formal support structures.

This burden is compounding a crisis that predates AI. Middle managers were already [carrying more responsibility than ever](https://www.wsj.com/business/boss-management-cuts-careers-workplace-4809d750?st=NHmc3q&reflink=desktopwebshare_permalink), as layoffs and reorganizations stripped away layers of support, leaving fewer people to supervise more employees. Gartner [predicts](https://www.gartner.com/en/newsroom/press-releases/2024-10-22-gartner-unveils-top-predictions-for-it-organizations-and-users-in-2025-and-beyond) that in 2026, 20% of organizations will use AI to flatten their structure, eliminating more than half of current middle management positions. And [Gallup finds](https://www.gallup.com/workplace/349484/state-of-the-global-workplace.aspx) that manager engagement has fallen sharply from 30% in 2023 to just 22% in 2025, the steepest decline in any employee group. AI didn’t create the middle-manager burnout problem. It accelerated it.
...
[Survey data from BCG](https://hbr.org/2025/11/leaders-assume-employees-are-excited-about-ai-theyre-wrong) shows that executives are roughly twice as likely as individual contributors to describe employees as enthusiastic about AI. Our research confirmed this perception gap and showed where it bites hardest: at the manager level.
